...
export default function TabMenu({ setCategory }: TabMenuProps) {
  ...
  return (
    <TabUl>
      ...
      <li
        className={activeCategory === "Front-end" ? "on" : ""}
        onClick={() => handleCategory("Front-end")}
      >
        Front-end
      </li>
      <li
        className={activeCategory === "Back-end" ? "on" : ""}
        onClick={() => handleCategory("Back-end")}
      >
        Back-end
      </li>
      <li
        className={activeCategory === "Responsive-web" ? "on" : ""}
        onClick={() => handleCategory("Responsive-web")}
      >
        Responsive Web
      </li>
    </TabUl>
